/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: e19f38b44155deefb1430795b09f8695)
// Runtime types generated with workerd@1.20251202.0 2025-08-21 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/worker");
		durableNamespaces: "SessionDurableObject" | "UserSessionDO";
	}
	interface Env {
		RATELIMIT_KV: KVNamespace;
		AUTH_CACHE_KV: KVNamespace;
		ALERT_CONFIG_KV: KVNamespace;
		BETTER_AUTH_URL: "https://flareup.dev";
		PRIMARY_DOMAIN: "flareup.dev";
		CF_ACCOUNT_ID: string;
		CF_API_TOKEN: string;
		CF_ZONE_ID: string;
		CF_R2_BUCKET: string;
		CF_DOMAIN: string;
		STATICFLARE_MODE: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "BETTER_AUTH_URL" | "PRIMARY_DOMAIN" | "CF_ACCOUNT_ID" | "CF_API_TOKEN" | "CF_ZONE_ID" | "CF_R2_BUCKET" | "CF_DOMAIN" | "STATICFLARE_MODE">> {}
}
